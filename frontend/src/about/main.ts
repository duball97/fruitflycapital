...
app.innerHTML = `
  <header class="site-header">
    ...
    <nav class="site-nav" aria-label="Primary navigation"><a href="/">Simulation</a><a class="is-active" href="/about/">About</a><a href="/portfolio/">Portfolio</a></nav>
  ...
  <footer class="site-footer"><span>FRUITFLY CAPITAL · AUTONOMOUS BIOLOGICAL FUND</span><a href="/">SIMULATION</a><a href="/portfolio/">PORTFOLIO</a><span class="footer-source">RESEARCH INSPIRED BY GOOGLE RESEARCH + HHMI JANELIA</span></footer>
`
